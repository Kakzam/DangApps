...
public class FoodFragment extends android.support.v4.app.Fragment {
    ...
    private FirebaseRecyclerAdapter<ModelFoodItem, FoodFragment.NewsViewHolder> mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new FirebaseRecyclerAdapter<ModelFoodItem, FoodFragment.NewsViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull FoodFragment.NewsViewHolder holder, final int position, @NonNull final ModelFoodItem model) {
            ...
            @NonNull
            @Override
            public FoodFragment.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
