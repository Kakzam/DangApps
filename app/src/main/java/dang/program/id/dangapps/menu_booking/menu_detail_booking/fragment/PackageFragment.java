 ...
 */
public class PackageFragment extends android.support.v4.app.Fragment {

    private RecyclerView recyclerView;
    private LinearLayoutManager mLayoutManager;
    private DatabaseReference mDatabase;
    private FirebaseRecyclerAdapter<ModelFoodItem, PackageFragment.NewsViewHolder> mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new FirebaseRecyclerAdapter<ModelFoodItem, PackageFragment.NewsViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull PackageFragment.NewsViewHolder holder, int position, @NonNull final ModelFoodItem model) {
            ...
            @NonNull
            @Override
            public PackageFragment.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
